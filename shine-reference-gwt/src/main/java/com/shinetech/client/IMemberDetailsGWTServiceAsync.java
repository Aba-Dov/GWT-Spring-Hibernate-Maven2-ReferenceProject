...
{    
    void countAll(AsyncCallback callback);
    void getMemberDetails(long memberNumber, AsyncCallback callback);
    void saveMemberDetails(MemberDTO member, AsyncCallback callback);
    void deleteMemberDetails(long id, AsyncCallback callback);
